...
- (BOOL)ymValidateHaveSpecialSymbols {
    NSString * symbols = [NSString stringWithFormat:@"^[A-Za-z0-9%@]+$", [[self class] chineseUnicode]];
    NSPredicate* predicate = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", symbols];
