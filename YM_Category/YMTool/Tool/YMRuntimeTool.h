...
typedef NS_ENUM(NSInteger, kAssociation) {
    /** assign */
    kAssociation_Assign = 0,
    /** retain nonatomic */
    kAssociation_Retain_Nonatomic = 1,
    /** copy nonatomic */
    kAssociation_Copy_Nonatomic,
    /** retain */
    kAssociation_Retain,
    /** copy */
    kAssociation_Copy
...
@interface YMRuntimeTool : NSObject
...
/**
 ...
 @return 特性值
 */
+ (NSString *)ymCopyPropertyAttributeValueOfPropery:(objc_property_t)property
