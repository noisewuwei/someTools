...
#pragma mark - YMNetworkSimplePing
@interface YMNetworkSimplePing ()
...
@implementation YMNetworkSimplePing
...
static void SocketReadCallback(CFSocketRef s, CFSocketCallBackType type, CFDataRef address, const void *data, void *info) {
    ...
    YMNetworkSimplePing *    obj;
    
    obj = (__bridge YMNetworkSimplePing *) info;
    assert([obj isKindOfClass:[YMNetworkSimplePing class]]);
