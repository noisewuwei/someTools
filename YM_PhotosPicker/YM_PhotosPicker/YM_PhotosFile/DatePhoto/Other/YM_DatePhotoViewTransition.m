...
@interface YM_DatePhotoViewTransition ()

@property (assign, nonatomic) YM_DatePhotoViewTransitionType type;

@end

@implementation YM_DatePhotoViewTransition
...
- (void)animateTransition:(nonnull id<UIViewControllerContextTransitioning>)transitionContext {
    switch (self.type) {
        case YM_DatePhotoViewTransitionType_Push:
...
- (void)pushAnimation:(id<UIViewControllerContextTransitioning>)transitionContext {
    YM_DatePhotoViewController *fromVC = (YM_DatePhotoViewController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    ...
    YM_PhotoModel *model = [toVC.modelArray objectAtIndex:toVC.currentModelIndex];
    kWeakSelf
...
- (void)pushAnim:(id<UIViewControllerContextTransitioning>)transitionContext image:(UIImage *)image model:(YM_PhotoModel *)model fromVC:(YM_DatePhotoViewController *)fromVC toVC:(YM_DatePhotoPreviewViewController *)toVC {
    model.tempImage = image;
    YM_DatePhotoViewCell *fromCell = [fromVC currentPreviewCell:model];
    if (!image) {
...
- (NSTimeInterval)transitionDuration:(nullable id<UIViewControllerContextTransitioning>)transitionContext {
    if (self.type == YM_DatePhotoViewTransitionType_Push) {
        YM_DatePhotoViewController *fromVC = (YM_DatePhotoViewController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
