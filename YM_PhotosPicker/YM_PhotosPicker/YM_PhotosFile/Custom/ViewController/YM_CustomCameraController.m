...
const CGFloat YM_ZoomRate = 1.0f;

@interface YM_CustomCameraController ()<AVCaptureFileOutputRecordingDelegate>
...
@implementation YM_CustomCameraController
