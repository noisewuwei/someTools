...
+ (void)addObserver:(id)observer
    ...
    // 注册通知
    [[self defaltTool] registerNotify:identifier];
...
#pragma mark - 系统通知
- (void)registerNotify:(NSString *)notifyIdentity {
    [[NSNotificationCenter defaultCenter] removeObserver:self name:notifyIdentity object:nil];
